...
@Component({
    selector: 'd-widget,div[dexihWidget]',
    templateUrl: './d-widget.component.html',
    styleUrls: ['./d-widget.component.scss'],
    animations: [
...
export class DWidgetComponent implements OnInit, AfterViewInit {
