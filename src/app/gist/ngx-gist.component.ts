  ...
  export class NgxGist implements AfterViewInit {
    ...
    ngAfterViewInit() {
      ...
      const content = `
          ...
          <script id="loadScript" type="text/javascript" src="https://gist.github.com/${this.gistId}.js?file=${fileName}"></script>
          </body>
        </html>
      `;
      doc.open();
      ...
      const loadScript = this.iframe.nativeElement.contentDocument.getElementById('loadScript') as HTMLScriptElement;

      loadScript.onload = () =>{
        this.iframe.nativeElement.height = doc.body.scrollHeight;
      };
    }
